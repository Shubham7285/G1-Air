...
<div class="container-fluid service_subpage_banner py-lg-0 py-4 px-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <?php
                    ...
                    if ($loop->have_posts()) {
                        while ($loop->have_posts()): $loop->the_post();
                            ...
                            if (strtotime($date) >= strtotime(current_time("m/d/Y")) || $noexpiry == 1) {
                                ...
                                <span class="d-block h1-alt text-uppercase"><?php echo get_post_meta(get_the_ID(), "promotion_title1", true); ?></span>
                ...
                if ($i == 0) {
                    ...
                    if (!empty($args["page_templates"]["service_subpage"]["banner"]["button_text"]) && !empty($args["page_templates"]["service_subpage"]["banner"]["button_link"])) {
                        ?>
                        <a href="<?php echo esc_url(get_home_url() . $args["page_templates"]["service_subpage"]["banner"]["button_link"]); ?>" class="btn btn-secondary mw-237 mt-3">
                            <?php echo esc_html($args["page_templates"]["service_subpage"]["banner"]["button_text"]); ?>
                            <i class=" icon-circle-chevron-right2
 ms-1 text_18 line_height_18 d-lg-inline-block"></i>
                        </a>
                        <?php
                    }
                }
