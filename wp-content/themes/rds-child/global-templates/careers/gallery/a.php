...
?>
<div class="container-fluid px-0 content_pt_40 content_pb_10 content_pt_lg_80 content_pb_lg_48">
    <div class="row">
        <div class="col-12"><h4 class="content_mb_44 text-center">Our Culture</h4></div>
        <div class="col-12">
            <div class="grid">
                <?php for ($i = 1; $i <= 13; $i++) {
                    ...
                    if (!empty($image_url)) {
                ?>
                    <div class="grid_inner content_mb_13 content_mb_lg_15 content_mb_xl_30">
