	...
	<div class="row content_pb_30">
        <div class="col-lg-4 col-md-4 col-12 content_mb_30 content_mb_md_0">
            <div class="input-group">
                ...
                <input type="text" id="search" value="<?php echo get_search_query(); ?>" name="s" class="form-control rounded-0 border-0   text_medium text_14 line_height_18 h-54" placeholder="SEARCH">
            </div>
        </div>
        <?php
