...
?>
<div class="row">
    <div class="col-lg-4 my-3 col-md-4 col-12">
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text color_primary_bg color_primary_hover_bg border-0 rounded-0 h-54 text-center w-54  cursor-pointer"><i class="icon-bars2   bc_text_18 bc_line_height_18 mx-auto true_white"></i></span>
            </div>
            <div class="custom-select gallery-cat-box">
